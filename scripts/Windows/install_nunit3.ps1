Write-Host "Installing NUnit 3.13.0..." -ForegroundColor Cyan -NoNewline
...
# nunit
$zipPath = "$env:TEMP\NUnit.Console-3.13.0.zip"
$tempPath = "$env:TEMP\NUnit.Console"
(New-Object Net.WebClient).DownloadFile('https://github.com/nunit/nunit-console/releases/download/3.13/NUnit.Console-3.13.0.zip', $zipPath)
