...
Measure-Command {
    ...
    $exePath = "$env:TEMP\boost_1_67_0-msvc-14.1-32.exe"
    (New-Object Net.WebClient).DownloadFile('https://bintray.com/boostorg/release/download_file?file_path=1.67.0%2Fbinaries%2Fboost_1_67_0-msvc-14.1-32.exe', $exePath)
    ...
    $exePath = "$env:TEMP\boost_1_67_0-msvc-14.1-64.exe"
    (New-Object Net.WebClient).DownloadFile('https://bintray.com/boostorg/release/download_file?file_path=1.67.0%2Fbinaries%2Fboost_1_67_0-msvc-14.1-64.exe', $exePath)
