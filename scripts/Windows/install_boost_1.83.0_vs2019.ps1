...
Measure-Command {
    ...
    $exePath = "$env:TEMP\boost_1_83_0-msvc-14.2-32.exe"
    (New-Object Net.WebClient).DownloadFile('https://boostorg.jfrog.io/artifactory/main/release/1.83.0/binaries/boost_1_83_0-msvc-14.2-32.exe', $exePath)
    ...
    $exePath = "$env:TEMP\boost_1_83_0-msvc-14.2-64.exe"
    (New-Object Net.WebClient).DownloadFile('https://boostorg.jfrog.io/artifactory/main/release/1.83.0/binaries/boost_1_83_0-msvc-14.2-64.exe', $exePath)
