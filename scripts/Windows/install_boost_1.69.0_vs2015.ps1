...
Measure-Command {
    ...
    $exePath = "$env:TEMP\boost_1_69_0-msvc-14.0-64.exe"
    (New-Object Net.WebClient).DownloadFile('https://bintray.com/boostorg/release/download_file?file_path=1.69.0%2Fbinaries%2Fboost_1_69_0-msvc-14.0-64.exe', $exePath)
