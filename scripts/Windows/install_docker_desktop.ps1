Write-Host "Installing Docker Desktop 2.3.0.2"

#choco install docker-desktop

Write-Host "Downloading..."
$exePath = "$env:TEMP\Docker-Desktop-Installer.exe"
(New-Object Net.WebClient).DownloadFile('https://download.docker.com/win/stable/45183/Docker%20Desktop%20Installer.exe', $exePath)
