...
$exePath = "$env:TEMP\postgresql-12.14-2-windows-x64.exe"
(New-Object Net.WebClient).DownloadFile('https://get.enterprisedb.com/postgresql/postgresql-12.14-2-windows-x64.exe', $exePath)
