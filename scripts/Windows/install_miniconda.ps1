...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda2-4.7.12.1-Windows-x86_64.exe' -OutFile $exePath
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda2-4.7.12.1-Windows-x86.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-3.16.0-Windows-x86_64.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-3.16.0-Windows-x86.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-4.2.12-Windows-x86_64.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-4.2.12-Windows-x86.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-4.5.4-Windows-x86_64.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-4.5.4-Windows-x86.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-py37_4.8.2-Windows-x86_64.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-py37_4.8.2-Windows-x86.exe' -OutFile $exePath
Write-Host "Installing..."
...
Invoke-WebRequest -Uri 'https://repo.continuum.io/miniconda/Miniconda3-py38_4.8.2-Windows-x86_64.exe' -OutFile $exePath
Write-Host "Installing..."
