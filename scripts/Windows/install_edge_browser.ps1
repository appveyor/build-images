...
(New-Object Net.WebClient).DownloadFile('http://dl.delivery.mp.microsoft.com/filestreamingservice/files/6937705c-f53d-45d3-8a09-f4ebbc0ecf10/MicrosoftEdgeEnterpriseX64.msi', $msiPath)
