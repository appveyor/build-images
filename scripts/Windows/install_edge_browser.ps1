...
(New-Object Net.WebClient).DownloadFile('https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/7a4d6bab-6ed2-49ee-bbb0-7b581034c84a/MicrosoftEdgeEnterpriseX64.msi', $msiPath)
