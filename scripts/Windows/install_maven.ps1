Write-Host "Installing Apache Maven 3.9.2 ..." -ForegroundColor Cyan
...
$zipPath = "$env:TEMP\apache-maven-3.9.2-bin.zip"
(New-Object Net.WebClient).DownloadFile('https://dlcdn.apache.org/maven/maven-3/3.9.2/binaries/apache-maven-3.9.2-bin.zip', $zipPath)

Write-Host "Unpacking..."
7z x $zipPath -oC:\apache-maven | Out-Null
[IO.Directory]::Move('C:\apache-maven\apache-maven-3.9.2', $mavenPath)
...
Write-Host "Apache Maven 3.9.2 installed" -ForegroundColor Green