...
$exePath = "$env:TEMP\postgresql-15.18-1-windows-x64.exe"
(New-Object Net.WebClient).DownloadFile('https://get.enterprisedb.com/postgresql/postgresql-15.18-1-windows-x64.exe', $exePath)
