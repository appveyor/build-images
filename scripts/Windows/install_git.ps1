Write-Host "Installing Git 2.26.2"
Write-Host "====================="
...
(New-Object Net.WebClient).DownloadFile('https://github.com/git-for-windows/git/releases/download/v2.26.2.windows.1/Git-2.26.2-64-bit.exe', $exePath)
