...
Write-Host "Installing PostgreSQL 13..." -ForegroundColor Cyan

Write-Host "Downloading..."
# http://www.enterprisedb.com/products-services-training/pgdownload#windows
$exePath = "$env:TEMP\postgresql-13.16-1-windows-x64.exe"
(New-Object Net.WebClient).DownloadFile('https://get.enterprisedb.com/postgresql/postgresql-13.16-1-windows-x64.exe', $exePath)
...
Write-Host "PostgreSQL 13 installed" -ForegroundColor Green