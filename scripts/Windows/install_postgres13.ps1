...
$exePath = "$env:TEMP\postgresql-13.10-2-windows-x64.exe"
(New-Object Net.WebClient).DownloadFile('https://get.enterprisedb.com/postgresql/postgresql-13.10-2-windows-x64.exe', $exePath)
